...
label myintro:
    ...
    me 'Сейчас я перемотаю 2 недели, чтобы всё стабилизировалось. Не пугайся, игра не зависла, просто нужно перемотать это время, чтобы отношения между учениками стабилизировались и вообще механика заработала. Может занять 1-2 минуты.'
    $changetime(60*24*14)
    me 'Готово!'
    me 'Я хочу выразить признательность всем людям, которые помогали мне с проектом не только словом, но и делом.'
    me 'irvin-zamora, спасибо тебе!'
