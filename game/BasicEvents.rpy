...
label myintro:
    ...
    player.say 'Можно взимодействовать с людьми напрямую через общение. Можно просто поговорить, это улучшает лояльность. Можно пофлиртовать, там будет проверка на волю собеседника и вашу развратность. Ещё что то может быть можно будет.'
