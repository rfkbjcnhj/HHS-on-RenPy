...
label myintro:
    ...
    player.say 'Образование вообще имеет в модификаторах счастье ученика и его интеллект. Да, несчастные ученики учатся в 4 раза медленнее, а тупые вообще необучаемы.'
