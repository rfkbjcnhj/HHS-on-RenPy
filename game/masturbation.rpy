...
label endMastur:
    ...
    'В расстроенном настроении вы начали приводить себя в порядок.'
    python:
        player.setLust(-100)
...
label mastur_orgasm:
    ...
    'Вы извиваетесь от скоращений мышц и громко стоните от сказочного удовольствия.'
...
label mastur_clit:
    ...
    if player.getLust() < 25:
        'Вы проводите пальцем по свему клитору и вас пронзает серия почти что болезненных ощущений.'
        ...
        'Блестящие от влаги пальцы порхали над клитором, то едва касаясь его, то сильно сжимая, заставляя тело вздрагивать от удовольствия.'
...
label mastur_1finger:
    ...
    if player.getLust() < 20:
        ...
        player.say 'Мде, сначала надо возбудиться...'
        python:
            endurance -= 5
            player.setLust(-5)
    elif player.getLust() < 50:
        ...
        'Лёгкий стон срывается с ваших губ, когда вы начинаете неторопясь трахать себя.'
        python:
            endurance += 5
            player.setLust(10)
    else:
