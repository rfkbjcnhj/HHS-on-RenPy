...
label mileQwest1_storage:
    ...
    menu:
        ...
        'Подсматривать':
            $ player.setCorr(1)
            show expression 'pic/events/mile_1/6.jpg' at top as tempPic
            ...
            hide movie
            show storage as bg
            show expression 'pic/events/mile_1/9.jpg' at top as tempPic
...
label mileQwest1_storageIn:
    ...
    if player.isSperm() != 2:
        ...
        show expression 'pic/events/mile_1/11.jpg' at top as tempPic
